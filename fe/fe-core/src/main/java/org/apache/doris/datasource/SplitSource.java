...
public class SplitSource {
    ...
    private final Iterator<Split> splitIterator;
    ...
    public synchronized boolean hasNext() {
        return index < numSplits;
    }

    public synchronized List<TScanRangeLocations> getNextBatch(int maxBatchSize) throws UserException {
        int batchSize = Math.min(maxBatchSize, numSplits - index);
        List<TScanRangeLocations> scanRanges = new ArrayList<>(batchSize);
